package com.ics.easy_ph_repair.Utilssss;
...
import com.ics.easy_ph_repair.BuildConfig;
...
/**
 * Created by ICS on 03/07/2018.
 */

public class CameraUtils__TRD {
     ...
     */
    public static Bitmap optimizeBitmap_TRD(int sampleSize, String filePath) {
        // bitmap factory
    ...
    public static Uri getOutputMediaFileUri_TRD(Context context, File file) {
     ...
     */
    public static File getOutputMediaFile_TRD(int type) {
        ...
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.e("Horizontal", "Oops! Failed create "
