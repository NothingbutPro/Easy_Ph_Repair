...
public class ReparingStuffAdapter extends RecyclerView.Adapter<ReparingStuffAdapter.MyViewHolder> {
    ...
    public ReparingStuffAdapter(Activity activity, List<ServiceStatusData> my_order_modelList) {
    ...
    public ReparingStuffAdapter(List<ServiceStatusData> my_order_modelList) {
        this.modelList = my_order_modelList;
    }

    @Override
    public ReparingStuffAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.serviceapprovalitem, parent, false);

        context = parent.getContext();

        return new ReparingStuffAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ReparingStuffAdapter.MyViewHolder holder, int position) {
...
//        holder.tv_office_add.setText(my_locatio_model.getPg_descri());
      ...
      if(my_locatio_model.getCheck_status().equals("Repairing"))
        {
...
//
//        public POstPayment(String selecteddel, String jobid, String sessionManager) {
